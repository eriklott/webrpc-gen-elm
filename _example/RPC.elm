...
{- 
    ...
    webrpc-gen -schema=test.ridl -target=../ -module=API -out=./RPC.elm
-}
...
type alias TestApi =
    { getEmpty : (Result Error () -> msg) -> Request () msg
    , getError : (Result Error () -> msg) -> Request () msg
    , getOne : (Result Error Simple -> msg) -> Request Simple msg
    , sendOne : Simple -> (Result Error () -> msg) -> Request () msg
    , getList : (Result Error (List Int) -> msg) -> Request (List Int) msg
    , getMulti : (Result Error { one : Simple, two : Simple, three : Maybe (List Simple), four : List Int } -> msg) -> Request { one : Simple, two : Simple, three : Maybe (List Simple), four : List Int } msg
    , sendMulti : Simple -> Simple -> Maybe Simple -> (Result Error () -> msg) -> Request () msg
    , getComplex : (Result Error Complex -> msg) -> Request Complex msg
    , sendComplex : Complex -> (Result Error () -> msg) -> Request () msg
    , sendComplexArgs : Dict Int String -> (Result Error () -> msg) -> Request () msg
    , getSchemaError : Int -> (Result Error () -> msg) -> Request () msg
    }
...
testApiGetEmpty : (Result Error () -> msg) -> Request () msg
...
testApiGetError : (Result Error () -> msg) -> Request () msg
...
testApiGetOne : (Result Error Simple -> msg) -> Request Simple msg
testApiGetOne toMsg =
    let
        encoder : Encode.Value
        encoder =
...
testApiSendOne : Simple -> (Result Error () -> msg) -> Request () msg
...
testApiGetList : (Result Error (List Int) -> msg) -> Request (List Int) msg
...
testApiGetMulti : (Result Error { one : Simple, two : Simple, three : Maybe (List Simple), four : List Int } -> msg) -> Request { one : Simple, two : Simple, three : Maybe (List Simple), four : List Int } msg
...
testApiSendMulti : Simple -> Simple -> Maybe Simple -> (Result Error () -> msg) -> Request () msg
...
testApiGetComplex : (Result Error Complex -> msg) -> Request Complex msg
...
testApiSendComplex : Complex -> (Result Error () -> msg) -> Request () msg
...
testApiSendComplexArgs : Dict Int String -> (Result Error () -> msg) -> Request () msg
...
testApiGetSchemaError : Int -> (Result Error () -> msg) -> Request () msg
